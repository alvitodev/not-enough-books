...
@section('content')
  <div class="bg-cover bg-center min-h-screen px-8 py-12" style="background-image: url('/images/background-library.jpg')">
    ...
    @endforeach
      ...
      @else
      <a href="{{ $recentlyAddedBooks->previousPageUrl() }}"
      ...
      <a href="{{ $recentlyAddedBooks->nextPageUrl() }}"
