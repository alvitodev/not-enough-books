  ...
  <div class="drawer lg:drawer-open bg-white">
    ...
    <div class="drawer-content flex flex-col">
      <div class="hero min-h-screen justify-start" style="background-image: url('/images/bg-primary.png');">
        <div class="w-full bg-cover bg-center px-10 py-12"
          style="background-image: url('/images/background-library.jpg')">
          <div class="w-full max-w-6xl mx-auto flex flex-col items-start">
            ...
            <div class="flex justify-center items-center mb-8 ml-10">
              <form action="{{ route('search-books-admin') }}" method="GET"
                class="flex w-[520px] bg-white rounded-full shadow-md overflow-hidden">

                <!-- Search Input -->
                <input type="text" name="query" placeholder="Find The Books You Like..."
                  class="input bg-white text-neutral border-none flex-1 focus:outline-none focus:ring-0 placeholder-base-300" />

                <!-- Search Button -->
                <button type="submit"
                  class="bg-primary text-white text-sm font-semibold rounded-full px-4 h-8 m-1 hover:bg-green-800 transition duration-300 ease-in-out">
                  Search
                </button>
              </form>
            </div>
            ...
            <div class="mb-10 w-full max-w-none">
              <div class="flex justify-between items-center mb-5 ">
                <a href="{{ route('latest-admin') }}" class="text-2xl text-white font-semibold px-8 block">Latest
                  Updates</a>
              </div>
        ...
        @endforeach
          ...
          <div class="mb-10 w-full max-w-none">
            <div class="flex justify-between items-center mb-5 ">
              <a href="{{ route('recently-admin') }}" class="text-2xl text-white font-semibold px-8 block">Recently
                Added</a>
            </div>
            <div class="flex flex-wrap gap-6 justify-start w-full">
