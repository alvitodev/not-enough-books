  ...
  <div class="drawer lg:drawer-open bg-white">
    ...
    <div class="drawer-content flex flex-col items-center justify-center">
      <div class="hero min-h-screen" style="background-image: url('/images/bg-primary.png');">
        <div class="bg-cover bg-center min-h-screen px-8 py-12"
          style="background-image: url('/images/background-library.jpg')">

          <div class="mt-10">
            <div class="flex justify-center">
              <div
                class="card w-full max-w-6xl bg-transparent backdrop-blur-md bg-base-100/30 border border-white/10 shadow-md rounded-xl overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-4">
                  <!-- Cover Image -->
                  <figure class="md:col-span-1">
                    <img src="{{ $book->cover_img ?? '/images/default-cover.jpg' }}" alt="Book Cover"
            ...
            <div class="mb-10 mt-10 w-full max-w-none">
              ...
              <div class="flex flex-wrap gap-6 justify-start w-full">
                @foreach ($recommendedBooksA as $recommended)
          <div
            ...
            <img src="{{ $recommended->cover_img ?? '/images/default-book.jpg' }}"
              alt="{{ $recommended->title }}" class="w-full h-full object-cover rounded-xl" />
            </figure>
            <div class="card-body px-3 py-0">
            <div class="flex flex-col space-y-1">
              <a href="{{ route('books.show-admin', $recommended->id) }}"
