  ...
  <div class="navbar fixed top-0 left-0 right-0 z-50 bg-transparent shadow-none">
    ...
    @endguest
      ...
      <form method="POST" action="{{ route('logout') }}" style="margin-left: 10px;">
        @csrf
        <button type="submit" style="color: white; background-color: red; padding: 5px; border-radius: 3px;">Test Sign
        Out</button>
      </form>
      {{-- END TEST LOGOUT --}}
  @endauth
        ...
        {{-- <div class="dropdown dropdown-end"> --}}
          {{-- <div tabindex="0" role="button" class="btn btn-ghost btn-xs text-white"> --}}
            ...
            {{-- </div> --}}
          {{-- <ul tabindex="0"
            class="dropdown-content menu menu-sm bg-base-100 rounded-box mt-3 w-35 p-2 shadow z-[1]"> --}}
            {{-- <li> --}}
